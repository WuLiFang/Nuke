...
# spell-checker: words   CHANGEDS autolabels nukescripts
...
knobChangeds: Dict[Str, list[Any]] = {}
...
def addKnobChanged(
    ...
    The knob is available in nuke.thisKnob() and the node in nuke.thisNode().
