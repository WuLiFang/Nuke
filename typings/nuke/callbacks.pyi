...
from typing import Any, AnyStr, Callable, Dict, Text, Tuple, TypeVar
...
def addKnobChanged(call: Callable[..., None], args: Tuple[Any, ...] = ..., kwarg: Dict[AnyStr, Any] = ..., nodeClass: six.binary_type = ..., node=...) -> None:
...
def addAutolabel(call: Callable[..., None], args: Tuple[Any, ...] = ..., kwarg: Dict[AnyStr, Any] = ..., nodeClass: six.binary_type = ...) -> None:
