...
def registerPanel(id: bytes, command: Callable[..., Any]) -> None:
    ...
...
def restorePanel(id: bytes) -> PythonPanel:
    ...
...
class PythonPanel(pyui.Dialog):
    ...
    def showModalDialog(self, defaultKnobText: bytes = ...) -> None:
        ...

    def showModal(self, defaultKnobText: bytes = ...) -> None:
        ...
