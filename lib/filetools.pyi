...
def get_layer(filename: six.text_type, layers: typing.List[six.text_type] = None) -> typing.Optional[six.text_type]:
    ...


def get_tag(filename: six.text_type, tag_pattern: six.text_type = None) -> six.text_type:
    ...
