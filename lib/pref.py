...
def set_knob_default():
    ...
    def _root():
        ...
        _ = nuke.knobDefault(b"Root.format", b"1920 1080 0 0 1920 1080 1 HD_1080")
    ...
    try:
        ...
        LOGGER.debug("Can not set localization preference, maybe using low version.")
