...
def nodePresetsStartup():
  ...
  nuke.setUserPreset("Grade", "Cache/EP15_SSS", {'note_font': '\xe5\xbe\xae\xe8\xbd\xaf\xe9\x9b\x85\xe9\xbb\x91', 'whitepoint': '0.53515625 0.4833984375 0.4733886719 1', 'selected': 'true', 'multiply': '0.35', 'gl_color': '0x9332ff00', 'white': '0.9 0.8 1.25 1'})
